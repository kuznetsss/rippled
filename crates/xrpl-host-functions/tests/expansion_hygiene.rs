...
//! names its expansion needs are the ones the declarations themselves spell, and
//! `WasmValType` — the type the generated signature table is made of, which the ABI
//! crate hand-writes because a proc-macro crate cannot export one.
